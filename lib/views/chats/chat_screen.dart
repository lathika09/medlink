...
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//             Text("widget.doctor_user",style: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.w500),),
//             SizedBox(height: 2,),
//             Text("last seen",style: TextStyle(fontSize: 13,color: Colors.black54,),),
//
//           ],
//         )
//       ],
...
// class ChatScreen extends StatefulWidget {
//   final ChatUser doctor_user;
//   const ChatScreen({Key? key,required this.doctor_user}) : super(key: key);
//
//   @override
//   State<ChatScreen> createState() => _ChatScreenState();
// }
...
//                     // final list=["hi","hello"];
//                     list.add(Message(toId: "toId", msg: "hii msg", read: "", type: Type.text, fromId: "lathika", sent: "12:00 AM "));
//                     list.add(Message(toId: "lathika", msg: "got msg", read: "", type: Type.text, fromId: "toId", sent: "12:05 AM "));
//
//                         if(list.isNotEmpty){
//                           return ListView.builder(
//                               itemCount:list.length,
